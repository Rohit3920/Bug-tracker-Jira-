        ...
        <div className="min-h-screen bg-gray-100 p-8 flex items-center justify-center">
            <div className="bg-white p-8 rounded-lg shadow-xl max-w-xl w-full">
                <h1 className="text-4xl font-extrabold text-gray-900 mb-8 text-center flex items-center justify-center">
                    <FontAwesomeIcon icon={faUserCircle} className="mr-4 text-blue-600" />
                    My Profile
                </h1>
                ...
                <div className="space-y-6">
                    <div>
                        <p className="text-sm font-semibold text-gray-500 mb-1 flex items-center">
                            <FontAwesomeIcon icon={faUserCircle} className="mr-2 text-gray-400" />Name:
                        </p>
                    ...
                    <div>
                        <p className="text-sm font-semibold text-gray-500 mb-1 flex items-center">
                            <FontAwesomeIcon icon={faEnvelope} className="mr-2 text-gray-400" />Email:
                        </p>
                    ...
                    <div>
                        <p className="text-sm font-semibold text-gray-500 mb-1 flex items-center">
                            <FontAwesomeIcon icon={faUserTie} className="mr-2 text-gray-400" />Roll:
                        </p>
                    ...
                    <div>
                        <p className="text-sm font-semibold text-gray-500 mb-1 flex items-center">
                            <FontAwesomeIcon icon={faIdCard} className="mr-2 text-gray-400" />User ID:
                        </p>
